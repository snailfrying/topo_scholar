...
![Knowledge](https://img.shields.io/badge/origin_records-3%2C205-b36b2c)
...
- 县级行政区：国家地名信息库可采集队列已跑完，已补齐 2,792 条；另从地方政府、民政、地方志及待复核参考来源人工补入 47 条，当前剩余 24 条 `needs_review` 项待多源补充。
...
- [x] 建立地名由来采集器、队列和候选审计。
- [x] 补齐省级、可采集地级地名由来。
- [ ] 继续补齐县级地名由来，优先处理剩余 24 条 `needs_review` 和乡镇/街道来源发现。
