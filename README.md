...
![Knowledge](https://img.shields.io/badge/origin_records-1%2C837-b36b2c)
...
# 小批量补齐县级地名由来
python scripts\batch_fetch_origins.py --max-items 100 --levels county --sleep 0.8 --max-pages 3 --max-attempts 3
```
